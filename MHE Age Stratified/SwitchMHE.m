...
ymeas_old = [ S_data.old';  [I_data.old(1) I_data.old']./Npop; D_data.old'./Npop; (T1_data.old + T2_data.mid)'./Npop; H_data.old'./Npop; E_data.old'./Npop ];  
ymeas_ger = [ S_data.ger';  [I_data.ger(1) I_data.ger']./Npop; D_data.ger'./Npop; (T1_data.ger + T2_data.mid)'./Npop; H_data.ger'./Npop; E_data.ger'./Npop ]; 
...
%% States equations posing and computation of the dynamics constraint
...
%                                       ---- Disturbances bounds ----
std_u40 = std(ymeas_u40,1,2);
std_mid = std(ymeas_mid,1,2);
std_old = std(ymeas_old,1,2);
std_ger = std(ymeas_ger,1,2);
...
column_names_sts = {    'S-u40', 'I-u40', 'D-u40', 'T-u40', 'H-u40', 'E-u40',...
                        'S-mid', 'I-mid', 'D-mid', 'T-mid', 'H-mid', 'E-mid',...
                        'S-old', 'I-old', 'D-old', 'T-old', 'H-old', 'E-old',...
                        'S-ger', 'I-ger', 'D-ger', 'T-ger', 'H-ger', 'E-ger'    };

column_names_par = {    'alp-u40', 'gam-u40', 'dlt-u40', 'sgm-u40', 'tau-u40',...
                        'alp-mid', 'gam-mid', 'dlt-mid', 'sgm-mid', 'tau-mid',...
                        'alp-old', 'gam-old', 'dlt-old', 'sgm-old', 'tau-old',...
                        'alp-ger', 'gam-ger', 'dlt-ger', 'sgm-ger', 'tau-ger'   };

% for ii = N_mhe:1:N_mhe+5
for ii = N_mhe:1:N-N_mhe
    ...
    % measurement update 
    opti.set_value(Ymeas_u40, ymeas_u40(:,ii-N_mhe+1:ii));
    opti.set_value(Ymeas_mid, ymeas_mid(:,ii-N_mhe+1:ii));
    opti.set_value(Ymeas_old, ymeas_old(:,ii-N_mhe+1:ii));
    opti.set_value(Ymeas_ger, ymeas_ger(:,ii-N_mhe+1:ii));
